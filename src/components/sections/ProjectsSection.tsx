...
const ProjectCard: React.FC<{ project: Project; index: number; total: number; scrollYProgress: MotionValue<number> }> = ({ project, index, total, scrollYProgress }) => {
...
const ProjectsSection = () => {
  ...
  const projects: Project[] = [
    {
      num: "01",
      category: t('projects.tags.arch'),
      name: t('projects.project1.title'),
      images: {
    ...
    {
      num: "02",
      category: t('projects.tags.electron'),
      name: t('projects.project2.title'),
      images: {
    ...
    {
      num: "03",
      category: t('projects.tags.perf'),
      name: t('projects.project3.title'),
      images: {
