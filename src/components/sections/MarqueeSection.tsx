...
const MarqueeSection = () => {
  ...
  return (
    <section ref={sectionRef} className="bg-[#0C0C0C] pt-24 pb-10 sm:pt-32 md:pt-40 overflow-hidden">
        ...
        >
          {row1Images.map((src, i) => (
            <img
              ...
              alt="Work"
              loading="lazy"
              className="w-[420px] h-[270px] flex-shrink-0 object-cover rounded-2xl"
            />
          ))}
        </div>
