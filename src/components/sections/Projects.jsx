...
const ProjectCard = ({ project, idx }) => {
  ...
  return (
    <motion.div
      ...
      className="group bg-white dark:bg-slate-950 rounded-[3.5rem] overflow-hidden border border-slate-100 dark:border-slate-800 shadow-xl hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.15)] transition-all duration-500 flex flex-col h-full relative hover:-translate-y-4"
    >
